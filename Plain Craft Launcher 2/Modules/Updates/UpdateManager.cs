...
public static class UpdateManager
{
    ...
    {
        // Custom build: update check disabled
    ...
    {
        // Custom build: auto-update disabled
        ModBase.Log("[Update] Custom build: auto-update disabled");
    }
    ...
    {
        // Custom build: skip CE announcement popup
    }
}
