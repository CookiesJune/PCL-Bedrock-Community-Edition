...
public class MsiXVDDecoder : IDisposable
{
	...
	private int DecryptHardware(ReadOnlySpan<byte> input, Span<byte> output, ReadOnlySpan<byte> tweakIv)
	{
		...
		while (num2 > 7)
		{
			...
			Vector128<byte> @out = Sse2.Xor(vector, Unsafe.Add(ref reference, 0));
			Vector128<byte> out2 = Sse2.Xor(vector2, Unsafe.Add(ref reference, 1));
			Vector128<byte> out3 = Sse2.Xor(vector3, Unsafe.Add(ref reference, 2));
			Vector128<byte> out4 = Sse2.Xor(vector4, Unsafe.Add(ref reference, 3));
			Vector128<byte> out5 = Sse2.Xor(vector5, Unsafe.Add(ref reference, 4));
			Vector128<byte> out6 = Sse2.Xor(vector6, Unsafe.Add(ref reference, 5));
			Vector128<byte> out7 = Sse2.Xor(vector7, Unsafe.Add(ref reference, 6));
			Vector128<byte> out8 = Sse2.Xor(vector8, Unsafe.Add(ref reference, 7));
			DecryptBlocks8(@out, out2, out3, out4, out5, out6, out7, out8, out @out, out out2, out out3, out out4, out out5, out out6, out out7, out out8);
