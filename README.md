...
- 内置 GravityCone / EasyTier 异地联机，无需额外配置
- 全面支持基岩版：启动、下载、版本与资源管理
- 跟随 PCL-CE 最新正式版内核
...
| 文件 | 说明 |
| --- | --- |
| `PCL-BCE_x64_v1.1.1.zip` | 压缩包，解压即用（约 18 MB） |
| `PCL-BCE_x64_v1.1.1.exe` | 单文件版（约 50 MB） |
...
- Built-in GravityCone / EasyTier remote LAN play, no extra configuration needed
- Full Bedrock support: launch, download, version and resource management
- Keeps up with the latest stable PCL-CE kernel
...
| File | Description |
| --- | --- |
| `PCL-BCE_x64_v1.1.1.zip` | Archive, extract and run (approx. 18 MB) |
| `PCL-BCE_x64_v1.1.1.exe` | Standalone executable (approx. 50 MB) |
...
*Copyright © 2026 小teto实验室 · 基于 Apache-2.0 协议发布 / Released under the Apache-2.0 License*
